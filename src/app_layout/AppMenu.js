...
import app_menu from "../jsons/app_menu.json";
...
export const AppMenu = (props) => {
    ...
    return (
        <div className="layout-menu-container">
            <AppSubmenu items={app_menu} className="layout-menu" onMenuItemClick={props.onMenuItemClick} root={true} role="menu" />
            <a href="https://www.primefaces.org/primeblocks-react" className="block mt-3">
                <img alt="primeblocks" className="w-full" src={layoutColorMode === "light" ? "assets/layout/images/banner-primeblocks.png" : "assets/layout/images/banner-primeblocks-dark.png"} />
            </a>
        </div>
    );
};
