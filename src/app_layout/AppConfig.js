...
import { inputStyleAtom, layoutModeAtom, themeAtom } from "../recoil/atoms/layoutAtom";
import { rippleEffectAtom } from "../recoil/atoms/rippleEffectAtom";

export const AppConfig = (props) => {
    /* Recoil states */
    const layoutMode = useRecoilValue(layoutModeAtom);
    // const layoutColorMode = useRecoilValue(layoutColorModeAtom); //assent color mode
    const [theme, setTheme] = useRecoilState(themeAtom);
    const rippleEffect = useRecoilValue(rippleEffectAtom);
    const inputStyle = useRecoilValue(inputStyleAtom);
            ...
            <div className="layout-config-content">
                ...
                <div className="p-formgroup-inline">
                    <div className="field-radiobutton">
                        <RadioButton inputId="input_outlined" name="inputstyle" value="outlined" onChange={(e) => props.onInputStyleChange(e.value)} checked={inputStyle === "outlined"} />
                        <label htmlFor="input_outlined">Outlined</label>
                    </div>
                    <div className="field-radiobutton">
                        <RadioButton inputId="input_filled" name="inputstyle" value="filled" onChange={(e) => props.onInputStyleChange(e.value)} checked={inputStyle === "filled"} />
                        <label htmlFor="input_filled">Filled</label>
                    </div>
                </div>

                <h5>Ripple Effect</h5>
                <InputSwitch checked={rippleEffect} onChange={props.onRippleEffect} />

                <h5>Menu Type</h5>
                <div className="p-formgroup-inline">
                    <div className="field-radiobutton">
                        <RadioButton inputId="static" name="layoutMode" value="static" onChange={(e) => props.onLayoutModeChange(e.value)} checked={layoutMode === "static"} />
                        <label htmlFor="static">Static</label>
                    </div>
                    <div className="field-radiobutton">
                        <RadioButton inputId="overlay" name="layoutMode" value="overlay" onChange={(e) => props.onLayoutModeChange(e.value)} checked={layoutMode === "overlay"} />
